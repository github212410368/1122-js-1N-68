export const tours_xx = [
  ...
  },
  {
    ...
    info: "Rick Steves' Best of Ireland tour kicks off with the best of Dublin, followed by Ireland's must-see historical sites, harming towns, music-filled pubs, and seaside getaways — including Kinsale, the D...",
    local_img: './img/ireland.jpeg',
    price: 3895,
  },
];

export const menu_xx = [];
